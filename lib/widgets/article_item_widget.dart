        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                Container(
                  child:
                  Image.network((widget.article.urlToImage==null||widget.article.urlToImage.isEmpty)?UrlImageNotFound:widget.article.urlToImage),
                  height: 130,
                  width: 130,
                ),
                SizedBox(width: 5,),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 10,),
                      Text(widget.article.title,style: TextStyle(fontWeight: FontWeight.bold),maxLines: 1,overflow: TextOverflow.ellipsis,),
                      SizedBox(height: 5,),
                      Text(widget.article.publishedAt.substring(0,10),style: TextStyle(color: Colors.grey),),
                      SizedBox(height: 10,),
          ...
          Material(
            ...
            child: InkWell(
              onTap: (){
                print('11');
                Navigator.pushNamed(context, WebviewScreen.id,arguments: widget.article);
              },
          ...
          Align(
              ...
              child: MaterialButton(
                ...
                child: Icon(Icons.favorite,color:this.widget.article.favorite ? Colors.yellow:Colors.grey,
                ),
              )),
        ],
      ),
